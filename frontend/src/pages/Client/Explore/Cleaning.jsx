...
const Cleaning = () => {
  ...
  return (
    <div className={`bg-[#f7f9fb] text-[#191c1e] min-h-screen flex flex-col font-['Inter'] relative overflow-x-hidden ${isDrawerOpen ? 'overflow-hidden' : ''}`}>
      ...
      <style>{`
        .hero-bg {
          background-image: linear-gradient(rgba(0, 0, 0, 0.55), rgba(0, 0, 0, 0.55)), url(https://images.unsplash.com/photo-1519710164239-da123dc03ef4?auto=format&fit=crop&w=1350&q=80);
      ...
      <aside className={`fixed left-0 top-0 h-full w-full max-w-md bg-white z-[70] shadow-2xl flex flex-col border-r border-[#bccac0] transition-transform duration-300 ease-in-out ${isDrawerOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        ...
        <div className="flex-grow overflow-y-auto p-6 space-y-[48px]">
          <div className="space-y-[4px]">
            ...
            <div className="text-[18px] text-[#006948] font-semibold">Specify the cleaning request</div>
          </div>
      ...
      <ClientHeader pageTitle="Cleaning" />
      ...
      <main className="flex-grow pt-16">
        <section className="hero-bg py-[80px] px-[32px] text-center text-white mb-[48px] min-h-[400px] flex items-center justify-center">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-[40px] font-bold mb-[12px] drop-shadow-lg leading-[1.2] tracking-[-0.02em]">A cleaner home starts here.</h1>
            <p className="text-[18px] max-w-2xl mx-auto drop-shadow-md opacity-95 leading-[1.6]">Discover trusted cleaning professionals for deep cleans, regular upkeep, and spotless results.</p>
          </div>
        </section>
        ...
        <div className="max-w-7xl mx-auto px-[32px] w-full">
          <section className="mb-[80px]">
            <h2 className="text-[32px] font-semibold text-[#191c1e] mb-[24px]">Featured Cleaning Specialists</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-[24px] mb-8">
              {[{name:'Nimali Perera',role:'Deep Clean Specialist',rating:'5.0',reviews:84,avail:'Available'},{name:'Ravi Jayasekara',role:'Home Cleaner',rating:'4.9',reviews:64,avail:'Available'},{name:'Maya Silva',role:'Carpet Expert',rating:'4.9',reviews:58,avail:'Available'},{name:'Kasun Fernando',role:'Window Specialist',rating:'4.8',reviews:41,avail:'Unavailable'},{name:'Anushka Gomes',role:'Sanitisation Expert',rating:'4.7',reviews:37,avail:'Unavailable'}].map((p,idx)=>(
                <div key={idx} className={`bg-white rounded-xl p-[24px] shadow-[0_4px_20px_-4px_rgba(6,78,59,0.05)] border ${idx===0? 'border-2 border-[#006948]/20':'border-[#eceef0]'} flex flex-col items-center text-center`}>
                  <div className="w-24 h-24 rounded-full mb-[12px] overflow-hidden border-2 border-[#006948] p-1">
                    <img alt={p.name} className="w-full h-full object-cover rounded-full" src={`https://source.unsplash.com/collection/888146/200x200?sig=${idx+80}`} />
                  </div>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-[24px]">
              <h2 className="text-[32px] font-semibold text-[#191c1e]">Active Cleaning Service Providers</h2>
              <button 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[24px]">
              {/* Active provider cards - dummy data */}
              {[{
                name: 'Nimali Perera', role: 'Deep Clean Specialist', city: 'Colombo', rating: '5.0', reviews: 84, slots: '6/10'
              },{
                name: 'Ravi Jayasekara', role: 'Home Cleaner', city: 'Kandy', rating: '4.9', reviews: 64, slots: '3/10'
              },{
                name: 'Maya Silva', role: 'Carpet & Upholstery', city: 'Galle', rating: '4.8', reviews: 42, slots: '5/10'
              },{
                name: 'Kasun Fernando', role: 'Window Specialist', city: 'Negombo', rating: '4.7', reviews: 37, slots: '4/10'
              },{
                name: 'Anushka Gomes', role: 'Sanitisation Expert', city: 'Matara', rating: '4.9', reviews: 51, slots: '7/10'
              }].map((p, idx) => (
                <div key={idx} className="bg-white rounded-xl p-[24px] shadow-[0_4px_20px_-4px_rgba(6,78,59,0.05)] border border-[#eceef0] flex flex-col h-full hover:border-[#006948]/40 hover:shadow-lg transition-all group">
                  <div className="flex items-center gap-[24px] mb-[24px]">
                    <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-[#006948]/10 flex-shrink-0">
                      <img alt={p.name} className="w-full h-full object-cover" src={`https://source.unsplash.com/collection/888146/100x100?sig=${idx}`} />
                    </div>
